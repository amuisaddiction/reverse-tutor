...
function App() {
  ...
  if (!examType) { return <><LoadingOverlay /><div className="min-h-screen bg-vercel-dark flex flex-col items-center justify-center font-sans p-8 relative overflow-hidden"><div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-3xl h-full max-h-[800px] bg-electric-indigo/10 blur-[120px] rounded-full pointer-events-none" /><div className="relative z-10 w-full max-w-4xl"><Onboarding onSelectExam={handleSelectExam} /></div></div></>; }
    return (
